...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'vine_e_commerce_f76eaaba6658738d5277_20230106101353_archive.zip';
        const ARCHIVE_SIZE       = '115361155';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f76eaab-06101353';
        const SECONDARY_PACKAGE_HASH = '20117cb-06101353';
        const VERSION            = '1.5.1';
